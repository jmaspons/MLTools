...
gatherResults.pipe_result.xgboost<- function(res, summarizePred, filenameRasterPred, nCoresRaster, repNames){
...
#'
#' @param modelXGB
#' @param predInput data.frame or raster with colnames or layer names matching the expected input for modelXGB
#' @param scaleInput
